...
public class WebShopApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		restTemplate.postForLocation("http://localhost:8080/customer/customer", customerDto);
		// get customer
		System.out.println("\n-----Customer-------");
		CustomerDTO customerDtoGet = restTemplate.getForObject("http://localhost:8080/customer/customer/101", CustomerDTO.class);
		...
		restTemplate.postForLocation("http://localhost:8080/cart/cart/1/A33/3", null);
		restTemplate.postForLocation("http://localhost:8080/cart/cart/1/A34/2", null);
		//get the shoppingcart
		ShoppingCartDTO cart = restTemplate.getForObject("http://localhost:8080/cart/cart/1", ShoppingCartDTO.class);
		System.out.println("\n-----Shoppingcart-------");
		if (cart != null) cart.print();
		//checkout the cart
		restTemplate.postForLocation("http://localhost:8080/cart/cart/checkout/1", null);
		//get the order
